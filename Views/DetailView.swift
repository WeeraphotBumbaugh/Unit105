//  DetailView.swift
//  Class105
//  Path: /Class105/Views/DetailView.swift
//
//  Refactor: keep the original design/layout, switch to PersistentBook + imageData.
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 30) {
                    ...
                    HStack {
                        ...
                        Spacer()
                        // Assumes you still have this component in your project
                    ...
                    if !book.summary.isEmpty { // description -> summary
                        VStack(alignment: .leading, spacing: 8) {
                            Text(book.summary)
                        }
                    }
...
#Preview {
    ...
    let b = PersistentBook(title: "Dune", author: "Frank Herbert", summary: "Epic sci‑fi.", rating: 4, review: "Loved it.", status: .reading, genre: .scifi, isFavorite: true)
    ctx.insert(b)
    try? ctx.save()
    return NavigationStack { DetailView(book: b) }
